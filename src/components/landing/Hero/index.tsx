  ...
  return (
    ...
    >
      ...
      <div className="ncf-hero-deco absolute right-[48px] top-[26px] z-[21] flex items-center gap-[14px] font-mono text-xs tracking-[1px] text-[rgba(245,245,250,.7)]">
        ...
        <span className="text-[rgba(245,245,250,.4)]">LIVE FEED · SECTOR-7G</span>
        <span className="border border-white/[0.15] px-2 py-[3px]">02:14:08</span>
      </div>

      {/* Left vertical text */}
      <div
        className="ncf-hero-deco absolute left-5 top-1/2 z-[21] -translate-y-1/2 rotate-180 writing-vertical font-mono text-[11px] tracking-[5px] text-[rgba(245,245,250,.32)]"
      >
      ...
      <div className="ncf-hero-deco absolute bottom-[40px] right-[48px] z-[21] flex flex-col items-center gap-[10px]">
        <span className="writing-vertical font-mono text-[10px] tracking-[3px] text-[rgba(245,245,250,.4)]">SCROLL</span>
      ...
      <div className="ncf-hero-content relative z-[20] mx-auto w-full max-w-[1380px] px-[48px] pb-[96px]">
        ...
        <div className="mb-[18px] flex items-center gap-[14px]">
          ...
          <span className="font-mono text-[13px] tracking-[5px] text-hazard">TALES OF NECROMUNDA</span>
        </div>
        ...
        <div className="ncf-hero-cta flex flex-wrap items-stretch gap-[18px]">
          ...
          <Link href="/dashboard" className={s.ctaPrimary}>
            <span className="text-[17px] font-bold tracking-[2px]">ENTER PUBLIC DASHBOARD →</span>
            <span className="mt-[3px] font-mono text-[11px] tracking-[1px] opacity-70">LIVE CAMPAIGN · 14,212 ONLINE</span>
          </Link>

          {/* Watch Trailer */}
          <div className={s.ctaSecondary}>
            <div className={s.trailerThumb}>
              <span className="relative text-[16px] text-white [text-shadow:0_0_8px_#00e5ff]">▶</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[14px] font-semibold tracking-[2px]">WATCH TRAILER</span>
              <span className="font-mono text-[11px] tracking-[1px] text-[rgba(245,245,250,.5)]">OFFICIAL REVEAL · 02:14</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Scanlines overlay */}
      <div className={`absolute inset-0 z-[8] pointer-events-none opacity-[0.8] ${s.heroScanlines}`} />

      {/* Vignette */}
      <div className={`absolute inset-0 z-[9] pointer-events-none ${s.heroVignette}`} />
    </div>
  );
}
