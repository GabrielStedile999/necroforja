...
// Carregado via next/dynamic (issue #42) — mantém @ai-sdk/react fora do
// bundle inicial e do SSR desta rota.
import { RulesChat } from "@/components/assistant/RulesChatLazy";
